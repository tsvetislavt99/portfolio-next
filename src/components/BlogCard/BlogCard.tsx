...
export default function BlogCard({
  ...
  return (
    <Link href={href}>
      <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:border hover:border-light-accent dark:hover:border dark:hover:border-light-secondary transition duration-300">
